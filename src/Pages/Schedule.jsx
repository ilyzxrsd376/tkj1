...
const Schedule = () => {
    ...
    piketGroup = [
        ["Rakha", "Jibril", "Raifandu", "Christian", "Farel", "Jovanda", "A.Faiz", "Fazle", "Intan"],
        ["Abelino", "Karin", "Fajar", "Ilyasa", "Yosua", "Naufal", "Panindra", "Meily", "Faiz"],
        ["Ferry", "Dwicky", "Harlan", "Raka", "Dava", "Gathan", "Halim", "Daffa", "Sheren"],
        ["Andre", "Azzikra", "Arbyan", "Lukman", "Radhitya", "Irfan", "Akmal", "Akmal", "Rizki", "Aliffia"]
        ]
        ...
        <>
            ...
            <div className="lg:flex lg:justify-center lg:gap-32 lg:mb-10 lg:mt-16 ">
                <div className="text-white flex flex-col justify-center items-center mt-8 md:mt-3 overflow-y-hidden">
                    ...
                    <div data-aos="fade-up" data-aos-duration="400">
                        {TodayComponent ? (
                            <React.Suspense fallback={<p>sabar...</p>}>
                                <TodayComponent />
                            </React.Suspense>
                        ) : (
                            <p className="opacity-50">sekarang libur</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="text-white flex flex-col justify-center items-center mt-8 lg:mt-0 lg:mb-[10rem] mb-10 overflow-y-hidden">
                ...
                {currentPiketNames && currentPiketNames.length > 0 ? (
                    ...
                    <p className="opacity-50">lah gatau</p>
                )}
            </div>
        </>
    )
